...
import { CartItemType, ReducerActionType, ReducerAction } from '../context/modules/CartProvider';
...
const CartCheckout = ({item, dispatch, REDUCER_ACTIONS}: Props) => {
    ...
    return (
        <li className="cart--item">
            ...
            <button className="cart--button"  title = "Remove Item From Cart" onClick ={onRemove}>
                delete item
            </button>
        </li>)
}
